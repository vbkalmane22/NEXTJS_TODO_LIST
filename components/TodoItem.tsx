...
const TodoItem: React.FC<TodoItemProps> = ({ todo, onToggle ,isDark}) => {
  ...
  const renderCategoryBadge = () => {
    ...
    return (
      <div
        className={`flex items-center gap-1 px-2 py-1 rounded-full ${categoryStyle}`}
      >
  ...
  return (
    ...
    >
      ...
      <span
        ...
        ${isDark ? 'text-gray-400':'text-[#1a237e]'}
      `}
      >
        {todo.text} -
      </span>
